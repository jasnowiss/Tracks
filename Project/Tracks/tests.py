...
class GetTest(TestCase):
    """Tests that webpages can be loaded and are associated with the proper urls."""
...
class SignUpTest(TestCase):
    """Tests that users can properly register with Tracks and don't conflict with other users."""
...
class SignInTest(TestCase):
    """Tests that existing users can sign in, and unregistered users cannot."""
...
class UserProfileTest(TestCase):
    """Tests that users can save and maintain basic profile information."""
