      ...
      /********************************** Functions of NISHANT KUMAR ***************************************/
        ...
        function collab_set_style_to(html_element_inside_collab, style_type) {
            if (is_inside_collab(html_element_inside_collab)){
                if (style_type.toLowerCase() == "play") {
                    $(html_element_inside_collab).parents(".collab_div_container")
                        .removeClass()
        ...
        */
        ...
        $('#id_file').change(function () {
            ...
            var new_bar = add_loading_track(file.name, $(this).parents("li"));
        ...
        function create_show_player_button(server_filename){
            ...
            $(show_player_button).bind("click", show_player);
        ...
        function create_collaborate_button(track_id){
            ...
            $(collaborate_button).bind("click", begin_collaboration);
        ...
        */
        ...
        /** ADD A DESCRIPTION */
        function turn_KV_data_into_select_input(data, class_string) {
        ...
        /** This replaces the ugliness from django with pretiness.
        function prettify() {
            $("#id_file").html("Upload");
        }
        prettify(); */
